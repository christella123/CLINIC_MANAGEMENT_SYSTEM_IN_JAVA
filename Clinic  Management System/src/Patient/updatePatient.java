...
public class updatePatient extends javax.swing.JFrame {
    ...
    public updatePatient() {
        ...
        Object columns[] = {"Serial no", "Date", "NID", "Name", "Age", "Gender", "Address", "Phone Number", "Status", "Disease", "Room Number"};
    ...
    private void pUTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pUTableMouseClicked
        ...
        int pId = Integer.parseInt((pUTable.getValueAt(row, 0).toString()));
        String pdate = (pUTable.getValueAt(row, 1).toString());
        String pNID = (pUTable.getValueAt(row, 2).toString());
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set date = '" + date + "', NID = '" + NID + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', address = '" + address + "', phone = '" + phone + "', status = '" + status + "', disease = '" + disease + "', room = '" + room + "' where id = '" + id + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
